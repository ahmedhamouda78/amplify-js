...
All relationship examples include `_version`, `_deleted`, and `_lastChangedAt` fields in selections for conflict-resolution-enabled backends. See the [Set up Apollo Client](/[platform]/build-a-backend/data/migrate-from-datastore/set-up-apollo/) page for details.
